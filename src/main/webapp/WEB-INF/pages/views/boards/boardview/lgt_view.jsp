...
<div class="location">
    <div class="centerThis">
        <span>모바일 임직원 특판</span> &gt; <span>LGT</span> &gt; <strong>목록</strong>
    </div>
</div>
    ...
    <div class="subSec">
        <div class="centerThis">
            ...
            <table class="tbView">
                ...
                <thead>
                <tr class="first">
                    <th colspan="4"><c:out value="${boardTitle}"/></th>
                </tr>
                <tr class="last">
                    <th>등록일</th>
                    <td>
                        <fmt:formatDate value="${boardRegDate}" pattern="yyyy.MM.dd HH:mm"/>
                    </td>
                    <th>조회수</th>
                    <td><c:out value="${boardReadCnt}"/></td>
                </tr>
                </thead>
                <tbody>
                <tr>
            ...
            <div class="btnArea tc">
                <a href="lgtBoard" class="btn_global">목록</a>
            </div>
        </div>
        <!--//centerThis-->
    </div>
