...
<div id="content_inner">
    ...
    <div class="subSec">
        <div class="centerThis">
            ...
            <form action="lgtBoard" method="get">
                <div class="searchBox">
                    <div class="srcSel">
        ...
        <div id="paging">
            <ul id="paging_ul">
                <c:if test="${pn > 1}">
                    <li class="paging_li">
                        <a href="${pageContext.request.contextPath}/lgtBoard?pn=${pn-1}">
                            <span>&laquo;</span>
                        </a>
                    </li>
                </c:if>
                <c:forEach varStatus="vs" begin="1" end="${maxPg}" step="1">
                    ...
                    <c:if test="${vs.current ne pn}">
                        <li class="paging_li">
                            <a href="${pageContext.request.contextPath}/lgtBoard?pn=${vs.current}">${vs.current}</a>
                        </li>
                    </c:if>
                </c:forEach>
                <c:if test="${pn < maxPg}">
