...
<div id="content_inner">
    ...
    <div class="subSec">
        <div class="centerThis">
            ...
            <form action="ktBoard" method="get">
                <div class="searchBox">
                    <div class="srcSel">
        ...
        <div id="paging">
            <ul id="paging_ul">
                <c:if test="${pn > 1}">
                    <li class="paging_li">
                        <a href="${pageContext.request.contextPath}/ktBoard?pn=${pn-1}">
                            <span>&laquo;</span>
                        </a>
                    </li>
                </c:if>
                <c:forEach varStatus="vs" begin="1" end="${maxPg}" step="1">
                    ...
                    <c:if test="${vs.current ne pn}">
                        <li class="paging_li">
                            <a href="${pageContext.request.contextPath}/ktBoard?pn=${vs.current}">${vs.current}</a>
                        </li>
                    </c:if>
                </c:forEach>
                <c:if test="${pn < maxPg}">
