...
<div class="location">
    <div class="centerThis">
        <span><a href="#">홈</a></span> &gt; <strong>회사소개</strong> &gt; <strong>이용약관</strong>
    </div>
</div>
        ...
        <div class="centerThis">
            ...
            <div class="subTabContent">
                <div id="company" class="tab-pane fade in active">
                    ...
                    <br><br>
                    제 1 조 (목적)<br>
                    이 약관은 Samsung M&amp;S(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.<br>
